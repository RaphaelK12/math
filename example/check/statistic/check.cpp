...
#include "math/statistic/statistic.hpp"
...
int main( int argc, char *argv[] )
 {
  ...
  ::math::statistic::average<float,int,3>        aa4; aa4.push( {1,2,3}  ); aa4.value( );
  ...
  ::math::statistic::average<float,int,1>        aa9; aa9.push( 1 ); aa9.value( );
