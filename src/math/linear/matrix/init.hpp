#ifndef Dh_math_linear_matrix_init
#define Dh_math_linear_matrix_init

 // ::math::linear::matrix::init(m,x,y)
 // ::math::linear::matrix::init(m,x,y,z)
 // ::math::linear::matrix::init(m,x,y,z,t)
