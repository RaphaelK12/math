      ...
      template<  typename scalar_name >
       void transform
         ...
         )
        {
         ...
         result[0] = ( matrix[0][0] * point[0] +  matrix[0][1] * point[1] + matrix[0][2] * point[1] + matrix[0][3] )/divisor;
         result[1] = ( matrix[1][0] * point[0] +  matrix[1][1] * point[1] + matrix[1][2] * point[1] + matrix[1][3] )/divisor;
         result[2] = ( matrix[2][0] * point[0] +  matrix[2][1] * point[1] + matrix[2][2] * point[1] + matrix[2][3] )/divisor;
