     ...
     namespace vector
      {
       ...
       template< typename scalar_name, unsigned dimension_number >
        ...
        convex
         ...
         )
         {
          ...
          scalar_name one_minus_coefficient = scalar_name(1) - one_minus_coefficient;

          while( I_result != result_param.data() )
           {
            --I_result; --I_left; --I_right;
             *I_result = one_minus_coefficient * *I_left + coefficient_param* ( *I_right - *I_left );
           }
         }
       ...
       template< typename scalar_name >
        ...
        convex
         ...
         {
          scalar_name one_minus_coefficient = scalar_name(1) - one_minus_coefficient;
          result_param[0] = one_minus_coefficient*left_param[0] + coefficient_param*( right_param[0] - left_param[0] );
          result_param[1] = one_minus_coefficient*left_param[1] + coefficient_param*( right_param[1] - left_param[1] );
         }
       ...
       template< typename scalar_name >
        ...
        convex
         ...
         )
         {
          ...
          result_param[0] = one_minus_coefficient*left_param[0] + coefficient_param*( right_param[0] - left_param[0] );
          result_param[1] = one_minus_coefficient*left_param[1] + coefficient_param*( right_param[1] - left_param[1] );
          result_param[2] = one_minus_coefficient*left_param[2] + coefficient_param*( right_param[2] - left_param[2] );
         }
       ...
       template< typename scalar_name >
        ...
        convex
         ...
         )
         {
          ...
          result_param[1] = one_minus_coefficient*left_param[1] + coefficient_param*( right_param[1] - left_param[1] );
          result_param[2] = one_minus_coefficient*left_param[2] + coefficient_param*( right_param[2] - left_param[2] );
          result_param[3] = one_minus_coefficient*left_param[3] + coefficient_param*( right_param[3] - left_param[3] );
         }
