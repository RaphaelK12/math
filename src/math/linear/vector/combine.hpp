#ifndef math_library_linear_algebra__vector_aritmetic_combine_HPP_
 #define math_library_linear_algebra__vector_aritmetic_combine_HPP_

 // ::math::linear::vector::combine( result, left, coefficient, right )
